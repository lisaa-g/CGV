...
int rotateX = 0;    // Rotations of the object6 about the axes.
...
void object3(){
    ...
    glutSolidCylinder(3.0, 5.0, 32, 8); 

    glTranslatef(0.0, 0.0, 5.0);
    glutSolidCone(3.0, 5.0, 32, 8);
...
void bar(){
    glColor3f(1.0, 0.0, 1.0);
    glutSolidCylinder(0.3, 8.0, 32, 32);
}
...
//ball and bar object used to make a square(object5)
void object5(){
    glPushMatrix();
    glTranslatef(-4.0, 4.0, 0.0);
    ball();
...
//square (object5) used to make the cube (object6)
void object6(){
    glPushMatrix();
    object5();
    glPopMatrix();
...
void draw() {
    ...
    // (Objects should lie in the object6 with x, y, and z coordinates in the
    // range -5 to 5.)
